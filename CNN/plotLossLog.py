...
df = pd.DataFrame(list(zip(epochs, training_loss, validation_loss, validation_accuracy)),
               columns =['Epochs', 'Training loss', 'Validation loss', 'Validation accuracy'])
