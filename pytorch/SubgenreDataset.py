...
class SubgenreDataset(Dataset):
    ...
    def _get_audio_sample_label(self, index):
        return self.annotations.iloc[index, 3] #3 = Class ID
...
if __name__ == "__main__":
    ...
    # Define the root directory where you want to start searching for audio files
